          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-3 items-center">
              ...
              <a
                ...
                className="size-10 rounded-full border border-white/10 flex items-center justify-center text-slate-300 hover:bg-accent-lime hover:text-background-dark hover:border-accent-lime transition-all"
              >
