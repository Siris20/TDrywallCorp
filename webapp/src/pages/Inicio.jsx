      ...
      <section className="relative h-[120vh] w-full flex items-center justify-start overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-20 w-full">
          <div className="max-w-2xl space-y-6">
            ...
            {/* Bloque de Redes Sociales en el Hero */}
            <div className="pt-6 border-t border-white/10 flex items-center gap-4 text-slate-400">
              <span className="text-sm font-medium">
                {t('inicio.hero.socialLabel', 'Síguenos en nuestras redes:')}
              </span>
              <div className="flex gap-3">
                {/* Instagram */}
                <a
                  href="https://www.instagram.com/tdrywallcorp?igsh=MTBmb2JxZ3VkbWwyeA=="
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Instagram"
                  className="size-10 rounded-full border border-white/10 flex items-center justify-center text-slate-300 hover:bg-td-green hover:text-td-dark hover:border-td-green transition-all"
                >
